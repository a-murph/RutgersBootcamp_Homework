...
function displayArr (arr, loc) {
	var arrDisplay = document.createElement("p");
	for (var i = 0; i < arr.length; i++) {
		arrDisplay.textContent= arrDisplay.textContent +arr[i] +", ";
	}
	document.getElementById(loc).appendChild(arrDisplay);
}

displayArr(unsortedArr, "start");

for (var i = unsortedArr.length - 1; i >= 0 ; i--) {
	for (var j = unsortedArr.length - i; j > 0; j--) {
