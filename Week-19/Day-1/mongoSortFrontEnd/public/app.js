...
function displayResults(data) {
	...
	data.forEach(function(element) {
		...
		newRow.append(`<td>${element.numLegs}</td>`);
		newRow.append(`<td>${element.class}</td>`);
		newRow.append(`<td>${element.weight}</td>`);
		newRow.append(`<td>${element.whatIWouldReallyCallIt}</td>`);
